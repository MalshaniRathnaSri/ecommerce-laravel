            ...
            <nav class="navbar navbar-default">
                <!-- <div class="container-fluid"> -->
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html"><img src="frontend/images/logo.png" alt=""></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="menu-search-form">
                                <a href="#" id="open-srch-form"><img src="frontend/images/srch.png" alt="srch"></a>
                            </li>
                            <li><a href="#"><img src="frontend/images/pav.png" alt="pav"><span>2</span></a></li>
                            <li><a href="#"><img src="frontend/images/bag.png" alt="bag"><span>2</span></a></li>
